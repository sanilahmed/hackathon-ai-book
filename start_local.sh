...
nohup npx docusaurus serve --host 127.0.0.1 --port 3000 > frontend_serve.log 2>&1 &
FRONTEND_PID=$!
...
echo "📍 Frontend UI: http://localhost:3000/hackathon-ai-book/"
echo "📍 API Docs: http://localhost:8000/docs"
echo ""
echo "💡 The site is now available at: http://localhost:3000/hackathon-ai-book/"
echo ""
echo "📝 Logs:"
