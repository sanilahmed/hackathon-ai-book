...
if [ "$1" = "backend" ]; then
    ...
    echo "   In local environments: http://localhost:3001/hackathon-ai-book/"
    echo "   In cloud environments (VS Code, Codespaces, etc.):"
    echo "   - Look for port forwarding options"
    echo "   - Use the 'Ports' tab to forward port 3001"
    ...
    echo "   2. Forward port 3001 (set to 'Public' if needed)"
